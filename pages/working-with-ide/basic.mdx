impoOne of KliveIDE's unique features is that it can list the BASIC program from within the running machine's memory. You can access this view with the **IDE | Show BASIC Listing** menu command:t { ClickableImage } from '../../components'
