...
- **Decimal**: Turns on or off the decimal display (off, by default). When turned off, memory addresses, opcodes, and instructions are displayed with hexadecimal numbers; otherwise, they are decimal.
